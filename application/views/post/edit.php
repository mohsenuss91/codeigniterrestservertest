<?php echo form_open('post/edit/'.$post['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="description" value="<?php echo ($this->input->post('description') ? $this->input->post('description') : $post['description']); ?>" class="form-control" id="description" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="date" value="<?php echo ($this->input->post('date') ? $this->input->post('date') : $post['date']); ?>" class="form-control" id="date" />
